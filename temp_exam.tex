...
\pagestyle{fancy}
\fancyhead[L]{\textbf{Year 11 Maths Advanced}}
...
\begin{minipage}[c]{0.7\textwidth}
    \LARGE \textbf{Year 11 Maths Advanced} \\[0.3cm]
    \Large \textbf{Functions \& Graphs, Trigonometry Set 1}
\end{minipage}
\hfill
\begin{minipage}[c]{0.3\textwidth}
    \raggedleft
    \includegraphics[width=1.2in]{/home/runner/workspace/assets/logo.png}
\end{minipage}
\vspace{0.5cm}
\hrule\vspace{0.4cm}
\noindent\textbf{Student Name:} \underline{\hspace{7cm}} \hfill \textbf{Class:} \underline{\hspace{3cm}} \\[0.4cm]
\textbf{Time Allowed:} 201 minutes \hfill \textbf{Total Marks:} 134
